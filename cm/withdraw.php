...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($amount && $amount > 0 && $withdrawal_method) {
        if ($amount <= $account_balance) {
            ...
            if ($stmt->execute()) {
                $success_message = "Withdrawal of $" . number_format($amount, 2) . " successful!";
        ...
        $error_message = "Invalid amount or withdrawal method.";
    }
}
?>
...
<head>
    ...
    <title>Withdraw - Cypress Markets</title>
        ...
        <div class="withdraw-container">
            ...
            <form method="POST" action="">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                        <input type="number" class="form-control" id="amount" name="amount" min="0.01" step="0.01" max="<?php echo $account_balance; ?>" required>
                    </div>
                </div>
                <div class="mb-3">
